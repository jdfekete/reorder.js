...
suite.addBatch({
  pearson: {
    ...
    harder() {
      const a = [
        0.38906616, 0.5773394, 0.17349286, 0.5540746, 0.93085356, 0.91643792,
        0.85663005, 0.15666242, 0.91411063, 0.50854478,
      ];
      const b = [
        0.2845388, 0.08112363, 0.81855562, 0.12360082, 0.96107274, 0.78954847,
        0.05820312, 0.34101782, 0.62052291, 0.25681059,
      ];
      const y = reorder.correlation.pearson(a, b);
      const e = 0.21706031819808619;
      //console.log('y = '+y+', e='+e);
    ...
    hard() {
      ...
      const Y = reorder.correlation.pearsonMatrix(X);
